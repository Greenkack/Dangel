...
# ... (Rest des Codes von locales.py bleibt gleich)
...
if __name__ == '__main__':
    ...
    if german_texts and german_texts.get("app_title") != "Solar App (Fallback)":
    ...
    if non_existent_texts and non_existent_texts.get("app_title") == "Solar App (Fallback)":
